...
// nav.js lives in the landing repo (ask-meridian.uk); the shared origin
// at meridian.ask-meridian.uk doesn't host it. No-op these so app.js
// runs unchanged under /miniapp/.
const initBurgerNav    = () => {}
const loadVersionBadge = () => {}
