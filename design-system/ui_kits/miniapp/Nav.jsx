function Nav() {
  return (
    <nav className="nav" aria-label="Primary">
      ...
      <button className="cmdk-trigger" type="button" aria-label="Open search palette">
      ...
      <a href="#" className="nav-gh-link" aria-label="View on GitHub">
      ...
      <button className="burger" type="button" aria-label="Toggle navigation menu">
