// WebAuthn (passkey) registration + authentication — copied from finance-mcp
// and retargeted at STUDIO_KV. Browser glue loads @simplewebauthn/browser
// from CDN in pages.ts.
//
// IMPORTANT: any change here should also land in finance-mcp/src/webauthn.ts.
// We don't share a package yet because the two workers have different Env
// types; consider extracting if a third worker appears.
